...
def _create_qc_workflow_v2(DATA, user_id, token, wps):
    ...
    yaml_document = [
        ...
        '        latest = ' + str(latest).lower(),
        '        init_enable = true',
        '        init_identifier = "QC_Init_User"',
        '        init_output = ["process_log", "all_okay"]',#[["all_okay",true]]',
        '        init_run = "run"',
        '        check_enable = true',
        '        check_identifier = "QC_Check_User"',
        ('        check_output = ["qc_call", "qc_call_exit_code", "qc_svn_version", "error_messages",' +
                 '"has_issues", "process_log", "to_publish_qc_files", "to_publish_metadata_files" ]'),
        '        eval_enable = true',
        ...
        '        publish_quality_identifier = "QC_QualityPublisher_User"',
        '        publish_quality_output = ["process_log"]',
        '        clean_enable = ' + str(clean).lower(),
        '        clean_identifier = "QC_RemoveData_User"',
        '        clean_output = []',
        '    outflows:',
