...
def _create_qc_workflow_v2(DATA, user_id, token, wps):
    ...
    yaml_document = [
        ...
        '        irods_enable = true',
        '        irods_identifier = "org.malleefowl.irods.rsync"',
        '        irods_output = ["output"]',
        '        irods_run = "run"',
        '        init_enable = true',
       ...
       ('        eval_output = ["found_tags", "fail_count", "pass_count", "omit_count", "fixed_count"' +
        ...
        '        irods_home: /variable/irods_home/',
        '        irods_collection: /variable/irods_collection/',
        '        select: /variable/select/',
        '        lock: /variable/lock/',
        '        project: /variable/project/',
        '        replica: /variable/replica/',
        '        latest: /variable/latest/',
        '        irods_enable: /variable/irods_enable/',
        '        irods_identifier: /variable/irods_id/',
        '        irods_output: /variable/irods_output/',
        '        irods_run: /variable/irods_run/',
        ...
        '  properties:',
        '    actor.step: | ',
        '      inputs = ["home=" + irods_home, "collection=" + irods_collection, "token=" + token] ',
        '    inflows:',
        '      irods_home: /variable/irods_home/',
        '      irods_collection: /variable/irods_collection/',
        '      token: /variable/token/',
        '    outflows:',
        '      inputs: /variable/irods_input/',
        '',
        '- id: MergeInputInit',
        '  type: GroovyActorNode',
        '  properties:',
        ...
        '    inflows: ',
        '      service: /variable/service/',
        '      run: /variable/irods_run/',
        '      enable: /variable/irods_enable/',
        '      identifier: /variable/irods_id/',
        '      input: /variable/irods_input/',
        '      output: /variable/irods_output/',
        '    outflows:',
        '      finished: /variable/irods_finished/',
        '      result: /variable/irods_result/',
        '      output: /variable/irods_last_output/',
        '',
        '- id: extract_data_path',
        '  type: PythonActorNode',
        '  properties: ',
        '    actor.step: |',
        '      url = irods_last_output',
        '      import urllib',
        '      f = urllib.urlopen(url)',
        '      lines = f.readlines()',
        '      data_path = lines[0]+"/CORDEX"',
        '    inflows:',
        '      irods_last_output: /variable/irods_last_output/',
        '    outflows:',
        '      data_path: /variable/data_path/',
        '',
        '- id: QC_Init',
