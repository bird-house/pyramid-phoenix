...
class CustomGrid(Grid):
    ...
    def render_format_td(self, format, source):
        ...
        """)
        return HTML.td(HTML.literal(anchor.substitute({"source": source, "span_class": span_class, "format": format})))
    ...
    def generate_header_link(self, column_number, column, label_text):
        ...
        return super(CustomGrid, self).generate_header_link(column_number, column, label_text)
