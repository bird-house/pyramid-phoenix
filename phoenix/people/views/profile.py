...
from phoenix.people.schema import ProfileSchema, TokenSchema, GroupSchema
...
class Profile(MyView):
    ...
    def appstruct(self):
        ...
        if token:
            ...
            expires_at = datetime.utcfromtimestamp(int(token.get("expires_at"))).strftime(
    ...
    def view(self):
        ...
        return dict(
            user_name=self.user.get("name", "Guest"),
