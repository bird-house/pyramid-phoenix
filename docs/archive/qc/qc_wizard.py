...
def qc_wizard_check(request):
    ...
    session_id_help = (
        "An identifier used to avoid processes running on the same directory."
    ...
    qc_select_help = (
        "Comma separated list of parts of the path descriptions."
    ...
    qc_lock_help = (
        "Works similar to select, but prevents the given paths being added. "
    ...
    fields = [
        {
            "id": "quality_server_address",
            "type": "text",
            "text": "URL to the Quality WPS",
            "value": DEFAULTQUALITYSERVER,
        },
        {"id": "session_id", "type": "text", "text": "Session ID", "help": session_id_help, "value": "web1"},
        ...
        {"id": "data_path", "type": "text", "text": "Root path of the to check data", "value": ""},
        {"id": "project", "type": "select", "text": "Project", "value": "CORDEX", "allowed_values": ["CORDEX"]},
        ...
        {"id": "publish_metadata", "type": "checkbox", "text": "Publish meta-data", "value": "", "checked": "checked"},
        {
            "id": "publish_quality",
            "type": "checkbox",
            "text": "Publish quality-data",
            "value": "",
            "checked": "checked",
        },
        {
            "id": "clean",
            "type": "checkbox",
            "text": "Clean afterwards",
            "value": "",
            "help": "Removes the work data after the steps have finished",
        },
    ]
...
def get_html_fields(fields):
    ...
    for field in fields:
        ...
        if field["type"] == "select":
            html_field["input_html"] = '<select name="' + field["id"] + '" value="' + field["value"] + '">\n'
...
def qc_wizard_yaml(request):
    ...
    fields = [
        ...
        {"id": "session_id", "type": "text", "text": "Session ID", "help": session_id_help, "value": "checkdone"},
